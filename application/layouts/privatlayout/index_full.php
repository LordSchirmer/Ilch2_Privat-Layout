      ...
      <div class="wrapper clearfix">
          ...
          <div class="grid_6 right">
              <ul>
                    ...
                    <li><a href="<?=$this->getUrl() ?>index.php/imprint/index/index"><?=$this->getTrans('impress') ?></a></li>
                    <li><a href="<?=$this->getUrl() ?>index.php/privacy/index/index"><?=$this->getTrans('disclaimer') ?></a></li>
              </ul>
          </div>
